/*
 *  @description: ISysRolePermissionsService.java
 *
 *  @author: xswang
...
package com.wxs.code.system.sysrolepermissions.service;
...
public interface ISysRolePermissionsService extends IService<SysRolePermissions> {
    ...
    default boolean saveOrUpdateBatch(Collection<SysRolePermissions> entityList) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    boolean saveOrUpdateBatch(Collection<SysRolePermissions> entityList, int batchSize);
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default boolean removeById(SysRolePermissions entity) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default boolean remove(Wrapper<SysRolePermissions> queryWrapper) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default boolean updateById(SysRolePermissions entity) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default boolean update(Wrapper<SysRolePermissions> updateWrapper) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default boolean update(SysRolePermissions entity, Wrapper<SysRolePermissions> updateWrapper) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default boolean updateBatchById(Collection<SysRolePermissions> entityList) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    boolean updateBatchById(Collection<SysRolePermissions> entityList, int batchSize);
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    boolean saveOrUpdate(SysRolePermissions entity);
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default KtUpdateChainWrapper<SysRolePermissions> ktUpdate() {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default UpdateChainWrapper<SysRolePermissions> update() {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default LambdaUpdateChainWrapper<SysRolePermissions> lambdaUpdate() {
    ...
    @Deprecated
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default boolean saveOrUpdate(SysRolePermissions entity, Wrapper<SysRolePermissions> updateWrapper) {
