...
public class SysLogController extends CoreController<SysLog> {
    ...
    public RspMsg<List<SysLog>> list(SysLog entity, HttpServletRequest req) {
    ...
    public RspMsg<IPage<SysLog>> queryPageList(SysLog entity,
    ...
    public RspMsg<SysLog> queryById(String id, HttpServletRequest req) {
    ...
    public RspMsg<String> edit(SysLog entity, HttpServletRequest req) {
    ...
    public RspMsg<String> add(SysLog entity, HttpServletRequest req) {
    ...
    public RspMsg<String> addBatch(List<SysLog> entity, HttpServletRequest req) {
