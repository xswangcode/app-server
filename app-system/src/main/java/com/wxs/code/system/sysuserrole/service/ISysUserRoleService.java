/*
 *  @description: ISysUserRoleService.java
 *
 *  @author: xswang
...
package com.wxs.code.system.sysuserrole.service;
...
public interface ISysUserRoleService extends IService<SysUserRole> {
    ...
    default boolean saveOrUpdateBatch(Collection<SysUserRole> entityList) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    boolean saveOrUpdateBatch(Collection<SysUserRole> entityList, int batchSize);
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default boolean removeById(SysUserRole entity) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default boolean remove(Wrapper<SysUserRole> queryWrapper) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default boolean updateById(SysUserRole entity) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default boolean update(Wrapper<SysUserRole> updateWrapper) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default boolean update(SysUserRole entity, Wrapper<SysUserRole> updateWrapper) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default boolean updateBatchById(Collection<SysUserRole> entityList) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    boolean updateBatchById(Collection<SysUserRole> entityList, int batchSize);
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    boolean saveOrUpdate(SysUserRole entity);
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default KtUpdateChainWrapper<SysUserRole> ktUpdate() {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default UpdateChainWrapper<SysUserRole> update() {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default LambdaUpdateChainWrapper<SysUserRole> lambdaUpdate() {
    ...
    @Deprecated
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default boolean saveOrUpdate(SysUserRole entity, Wrapper<SysUserRole> updateWrapper) {
