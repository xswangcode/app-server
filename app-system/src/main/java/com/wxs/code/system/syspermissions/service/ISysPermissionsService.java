/*
 *  @description: ISysPermissionsService.java
 *
 *  @author: xswang
...
package com.wxs.code.system.syspermissions.service;
...
public interface ISysPermissionsService extends IService<SysPermissions> {
    ...
    default boolean saveOrUpdateBatch(Collection<SysPermissions> entityList) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    boolean saveOrUpdateBatch(Collection<SysPermissions> entityList, int batchSize);
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default boolean removeById(SysPermissions entity) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default boolean remove(Wrapper<SysPermissions> queryWrapper) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default boolean updateById(SysPermissions entity) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default boolean update(Wrapper<SysPermissions> updateWrapper) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default boolean update(SysPermissions entity, Wrapper<SysPermissions> updateWrapper) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default boolean updateBatchById(Collection<SysPermissions> entityList) {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    boolean updateBatchById(Collection<SysPermissions> entityList, int batchSize);
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    boolean saveOrUpdate(SysPermissions entity);
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default KtUpdateChainWrapper<SysPermissions> ktUpdate() {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default UpdateChainWrapper<SysPermissions> update() {
    ...
    @Override
    @CacheEvict(value = {RedisConstants.GET_PERMISSION_LIST_KEY, RedisConstants.GET_ROLE_LIST_KEY}, key = "#StpUtil.getLoginId() + ':' + #StpUtil.getLoginType()")
    default LambdaUpdateChainWrapper<SysPermissions> lambdaUpdate() {
